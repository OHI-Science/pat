...
# INSTRUCTIONS Run this script one time only. This will download the WebApps'
...
library(httr)
dir_gh  = '~/github/gye/webapps_templates'
...
for (f in c('regions.brew.md',   # ohi-science.org/gye/regions -> renders with layers/rgn_labels.csv
            'layers.brew.md',    # ohi-science.org/gye/layers  -> renders with layers.csv
            'goals.brew.md',     # ohi-science.org/gye/goals   -> renders with conf/goals.Rmd
            'scores.brew.md'     # ohi-science.org/gye/scores  -> renders with scores.csv
            )){
